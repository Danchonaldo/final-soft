...
import soft.softfinal.mappers.UserMapper;
import soft.softfinal.repositories.PermissionRepository;
import soft.softfinal.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDTO register(UserRequestDTO request) {
        ...
        if (Objects.isNull(checkUser)) {
            ...
            Permission defaultRole = permissionRepository.findByPermission("ROLE_PATIENT");
